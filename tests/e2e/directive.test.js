...
describe('Puppeteer Directive Tests', () => {
  ...
  it('Test default integer model', async () => {
    await page.goto(`${serverUrlWithTarget}&directiveAmount=12`);

    expect(await getValue()).toBe('0.12');

    await page.goto(`${serverUrlWithTarget}&directiveAmount=12.00`);

    expect(await getValue()).toBe('12.00');

    await page.goto(`${serverUrlWithTarget}&directiveAmount=12&useModelNumberModifier=true`);

    expect(await getValue()).toBe('12.00');

    await page.goto(`${serverUrlWithTarget}&directiveAmount=12.1&useModelNumberModifier=true`);

    expect(await getValue()).toBe('12.10');
  });

  it('Test default float model', async () => {
    await page.goto(`${serverUrlWithTarget}&directiveAmount=12.1`);
